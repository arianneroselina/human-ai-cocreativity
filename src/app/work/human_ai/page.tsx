...
export default function HumanAIWorkPage() {
  ...
  const submit = () => {
    setLocked(true);
    console.log("[submitted]", { workflow: "human_ai", length: text.length, words, text });
      ...
      <div className="sticky top-0 z-10 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto max-w-4xl p-4 flex items-center gap-3">
          ...
          <div className="mr-auto">
            ...
            <p className="text-xs text-gray-500">Workflow: <span className="font-medium text-gray-800">Human → AI</span></p>
          </div>
